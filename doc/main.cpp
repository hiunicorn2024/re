...
void doc_matrix() {
  ...
  //
  //   cover(x, y, m)->pair<size_type, size_type> // return relaced wid-hei
  //   cover(x, y, m, mix_f)->pair<size_type, size_type>
  //
  //   row(n)
  //   rows()
  //   column(n)
...
void doc_key_controller() {
  ...
  //
  // key_controller
  //   smf: non-copyable and non-movable
  //
  //   unset_focus()
  //   press(c) // is_lower_modifier_key(c) || !is_modifier_key(c)
  //   release(c)
  //
  //   clear()
  //   empty()
  //
  //   pressed(c)
  //   contains(pair<key_combination, key_action>)
  //
...
void doc_bitmap() {
  ...
  //   bitmap(w, h)
  //   bitmap(w, h, fll)
  //   explicit bitmap(zvec2)
  //   bitmap(zvec2, fll)
  //
  //   bitmap(w, h, const bitmap &)
  //   bitmap(w, h, const bitmap &, fll)
  //   bitmap(zvec2, const bitmap &)
  //   bitmap(zvec2, const bitmap &, fll)
  //
  //   bitmap(w, h, r)
  //   bitmap(zvec2, r)
  //
  ...
  //   column(n)
  //   columns()
  //   sub_range(x, y, w, h) // includes_point(x, y)
  //   sub_range(zvec2 p, zvec2 sz) // includes_point(p)
  //
  //   ()(x, y)
  //   ()(zvec2)
  //   iter(x, y)
  ...
  //   resize(zvec2, fll)
  //
  //   cover(x, y, const bitmap &)->pair<size_type, size_type>
  //   cover(zvec2, const bitmap &)->pair<size_type, size_type>
  //   cover(x, y, const bitmap &, mix_f)->pair<size_type, size_type>
  //   cover(zvec2, const bitmap &, mix_f)->pair<size_type, size_type>
  //
  //   capacity()
  //   reserve(size_type)
...
void doc_freetype() {
  // ft_face
  //   smf: only constructible
  //   ft_face(file_string, height)
  //   empty()->bool
  //   size(h)
  //   size()->size_t
  //   index(u32_code)->unsigned
  //   index(sv)->unsigned // sv reprent a single character
  //   render(id)->matrix<unsigned char>
  //   render(id, u32_color)->bitmap
  //   render_black(id)->bitmap
}
//todo
void doc_window() {
  // window
  //   smf: only constructible
  //
  //   container = window_tree_vector;
  //   iterator
  //   const_iterator = window_tree_vector::const_iterator;
  //   iter()
  //   iter(iterator)
  //
  //   has_keys()->bool
  //   keys()->key_controller_ref
  //   keys(bool)
  //
  //   has_focus()->bool
  //   virtual set_focus()
  ...
  //
  //   min_size()->zvec2
  //   virtual min_size(zvec2)
  //   max_size()->zvec2
  //   virtual max_size(zvec2)
  //   size()->zvec2
  //   virtual size(zvec2)
  //
  //   virtual paint(bitmap &) = 0
  //
  //   position()->zvec2
  //   virtual move_to(zvec2);
  //
  //   hidden()->bool
  //   virtual show();
  //   virtual hide();
...
int main() {
  ...
  re::inner::fns::doc_key_controller();
  re::inner::fns::doc_vector_math();
  re::inner::fns::doc_rgba();
  re::inner::fns::doc_bitmap();
