...
void doc_allocator_wrapper() {
  ...
  //     // construct head by s...
  //     // requires: n is valid
  //   deallocate_headed_buffer(headed_buffer_ptr) // auto destroy head type
  //
