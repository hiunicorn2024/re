      ...
      for (int n2 : irng(0, 50)) {
        type_pack_for_each<P>
          ([n1, n2, init, good](auto a, auto b, auto c, auto d, auto e) {
            ...
            using t = avltree_adaptor<avltree_traits
                                      <avltree_node<int>, 0, 1, 1,
                                       alloc_t>>;
            alloc_t a1;
...
void test_avl_set_common_operations_impl(F mk, F2 key) {
  // special member functions
  {
...
void test_avl_set_common_operations() {
  test_avl_set_common_operations_impl<avl_set
                                      <int, less<int>,
                                       stateful_test_allocator<int>>>
    (copy, identity{});
  test_avl_set_common_operations_impl<avl_map
                                      <int, int, less<int>,
...
template <class S, class F, class F2>
void test_avl_multiset_common_operations_impl(F mk, F2 key) {
  // special member functions
  {
    static_assert(regular<S>);
    static_assert(is_nothrow_movable_v<S>);
...
void test_avl_multiset_common_operations() {
  test_avl_multiset_common_operations_impl<avl_multiset
                                           <int, less<int>,
                                            stateful_test_allocator<int>>>
    (copy, identity{});
  test_avl_multiset_common_operations_impl<avl_multimap
                                           <int, int, less<int>,
...
template <class S>
void test_avl_map_specialized_operations_impl() {
...
void test_avl_map_specialized_operations() {
  test_avl_map_specialized_operations_impl
    <avl_map<int, int, less<int>, test_allocator<pair<int, int>>>>();
  test_avl_map_specialized_operations_impl
    <avl_map<int, int, less<>, test_allocator<pair<int, int>>>>();
}

void test_avl_map() {
  printf("avl_map: ");

  inner::test::test_avltree_adaptor();
  inner::test::test_avl_set_common_operations();
  inner::test::test_avl_multiset_common_operations();
  inner::test::test_avl_map_specialized_operations();
