...
void test_test() {
  ...
  inner::test::test_owner_ptr();
  inner::test::test_test_throwing();
  inner::test::test_test_ownership();
  inner::test::test_rational_operator_test();
  inner::test::test_instance_counter();
  inner::test::test_ez_function();
  inner::test::test_ez_vector();
  inner::test::test_ez_forward_list();
  inner::test::test_ez_bidirectional_list();
  inner::test::test_ez_list();
  inner::test::test_ez_map();
  inner::test::test_test_allocator();
  inner::test::test_test_object();
  inner::test::test_test_range();
