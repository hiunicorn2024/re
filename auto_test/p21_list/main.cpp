...
void test_list() {
  ...
  inner::test::test_list_intrusive_mode<false>();
  inner::test::test_list_intrusive_mode<true>();
  inner::test::test_list_briefly<list<int, stateful_test_allocator<int>>>();
  inner::test::test_list_briefly<list<test_object<int>,
                                      stateful_test_allocator
                                      <test_object<int>>>>();
  inner::test::test_list_briefly<list_adaptor
                                 <list_traits
                                  <list_node<int, stateful_test_allocator<int>>,
                                   0, 0, 1, stateful_test_allocator<int>>>>();
  inner::test::test_list_carefully<list<int, stateful_test_allocator<int>>>();
  inner::test::test_list_carefully<list<test_object<int>,
                                        stateful_test_allocator
                                        <test_object<int>>>>();
  inner::test::test_list_exception_safety_of_insert();
  inner::test::test_list_node_and_slice();
