...
void test_forward_list() {
  ...
  inner::test::test_forward_list_ownership();
  inner::test::test_forward_list_intrusive_mode();
  inner::test::test_forward_list_briefly<forward_list
  ...
  inner::test::test_forward_list_briefly<forward_list
                                         <test_object<int>,
                                          ...
                                          <test_object<int>>>>();
  inner::test::test_forward_list_carefully
    <forward_list<int, stateful_test_allocator<int>>>();
  inner::test::test_forward_list_carefully<forward_list
                                           <int, test_allocator<int>>>();
  inner::test::test_forward_list_carefully
    <forward_list
     <test_object<int>,
      stateful_test_allocator<test_object<int>>>>();
  inner::test::test_slist<slist<int, test_allocator<int>>>();

  inner::test::test_forward_list_replace();
  inner::test::test_forward_list_node_and_slice();
