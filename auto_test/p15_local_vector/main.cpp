...
void test_local_vector() {
  ...
  inner::test::test_local_vector_ownership();
  inner::test::test_local_vector_briefly<local_vector<int, 20>>();
  inner::test::test_local_vector_briefly<local_vector<test_object<int>, 20>>();
  inner::test::test_local_vector_construct_from_range();
  inner::test::test_local_vector_assign_range();
  inner::test::test_local_vector_erase();
  inner::test::test_local_vector_insert_1_back();
  inner::test::test_local_vector_insert_1();
  inner::test::test_local_vector_insert_range_back();
  inner::test::test_local_vector_insert_range();
  inner::test::test_local_vector_clear();
  inner::test::test_local_vector_resize();
