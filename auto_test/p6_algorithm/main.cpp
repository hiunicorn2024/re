...
void test_minmax() {
  ...
  assert(min(1, 2) == 1);
  assert(min(2, 1) == 1);
  assert(min(3.1, 3.2, [](double x, double y) {return (int)x < (int)y;})
         == 3.1);
  assert(max(1, 2) == 2);
  assert(max(2, 1) == 2);
  assert(max(3.2, 3.1, [](double x, double y) {return (int)x < (int)y;})
	 == 3.2);
  assert(minmax({2}) == make_pair(2, 2));
  assert(minmax({2, 1}) == make_pair(1, 2));
  assert(minmax({1.1, 1.2},
                [](double x, double y) {return (int)x < (int)y;})
	 == make_pair(1.1, 1.2));
  assert(minmax({1.1, 1.2, 1.3},
                [](double x, double y) {return (int)x < (int)y;})
	 == make_pair(1.1, 1.3));
  assert(minmax({4.0, 1.1, 9.0, 1.2, 1.3, 5.0, 10.1, 10.2, 8.0, 10.3, 3.0},
                [](double x, double y) {return (int)x < (int)y;})
	 == make_pair(1.1, 10.3));
  assert(min({4.0, 1.1, 9.0, 1.2, 1.3, 5.0, 10.1, 10.2, 8.0, 10.3, 3.0},
             [](double x, double y) {return (int)x < (int)y;})
         == 1.1);
  assert(max({4.0, 1.1, 9.0, 1.2, 1.3, 5.0, 10.1, 10.2, 8.0, 10.3, 3.0},
             [](double x, double y) {return (int)x < (int)y;})
         == 10.1);
}
...
void test_permutation() {
  ...
  }
  {
...

    {
      ...
      assert(c == permutation_count(ssize(v))
