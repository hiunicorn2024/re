...
void test_flat_map() {
  ...
  inner::test::test_flat_set_common_operations();
  inner::test::test_flat_set_unique_operations();
  inner::test::test_flat_set_equal_operations();
  inner::test::test_flat_map_specialized_operations();
