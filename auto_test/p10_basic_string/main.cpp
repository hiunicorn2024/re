...
void test_basic_string() {
  inner::test::test_string_briefly<basic_string<int>>();
  inner::test::test_string_briefly
    <basic_string<int, stateful_test_allocator<int>>>();
  inner::test::test_string_briefly<basic_string<test_object<int>>>();
  inner::test::test_basic_string_1();
  inner::test::test_basic_string_2();
  inner::test::test_basic_string_ownership();
  inner::test::test_basic_string_construct_from_range();
  inner::test::test_basic_string_assign_from_range();
  inner::test::test_basic_string_erase();
  inner::test::test_basic_string_insert_1_back();
  inner::test::test_basic_string_insert_1();
  inner::test::test_basic_string_insert_range_back();
  inner::test::test_basic_string_insert_range();
  inner::test::test_basic_string_clear();
  inner::test::test_basic_string_resize();
  inner::test::test_basic_string_reallocate();
  inner::test::test_basic_string_shrink_to_fit();
}

void test_string() {
  printf("container - basic_string: ");

  inner::test::test_basic_string();
