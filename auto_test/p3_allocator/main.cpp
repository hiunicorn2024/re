...
void test_allocator_wrapper() {
  ...
  // min_alignment
  {
    ...
    alw2_t a2{};
    alw3_t a3{};
    assert(a.min_alignment() == __STDCPP_DEFAULT_NEW_ALIGNMENT__);
    assert(a2.min_alignment() == __STDCPP_DEFAULT_NEW_ALIGNMENT__);
    assert(a3.min_alignment() == __STDCPP_DEFAULT_NEW_ALIGNMENT__);
...
void test_unique_ptr() {
  ...
  // default_delete
  {
    static_assert(same_as<default_delete<int>,
                          alloc_delete<default_allocator<int>>>);
  }
  ...
  {
    unique_ptr<int> p;
    using d_t = alloc_delete<default_allocator<int>>;
...
void test_unique_array() {
  ...
  // member types
  {
    ...
    static_assert(same_as
                  <t::deleter_type, alloc_delete<default_allocator<int>>>);
    static_assert(same_as<t::pointer_pair, iter_pair<int *>>);
  }
  // special member functions and swap
  {
    using alloc_t = stateful_test_allocator<int>;
