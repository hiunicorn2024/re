...
void test_rb_map() {
  ...
  inner::test::test_rbtree_adaptor();
  inner::test::test_rb_set_common_operations();
  inner::test::test_rb_multiset_common_operations();
  inner::test::test_rb_map_specialized_operations();
