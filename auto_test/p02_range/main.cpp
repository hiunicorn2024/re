...
namespace re::inner::test::help_iterator_requirements {
...
template <>
struct iterator_traits<inner::test::help_iterator_requirements
...
void test_iters() {
  ...
  for (auto x : iters(0, 0))
    throw_or_terminate<logic_error>("test_iters 0\n");
