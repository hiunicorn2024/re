...
void test_tree_mscl_for_sequence_container() {
  ...
  // first_order_reserve(i, n)
  {
    ...
    x = t(1, t(2, t(3), t(4)), t(5));
    x.first_order_reserve(x.root(), 1000);
    for (auto &u : x.root().first_order())
  ...
  // first_order_shrink_to_fit(i)
  {
    ...
    x.first_order_shrink_to_fit(x.root());
    for (auto &u : x.root().first_order())
...
void test_tree_vector_mscl_for_sequence_container() {
  ...
  // first_order_reserve(i, n);
  {
    ...
    v.first_order_reserve(200u);
    assert(all_of(v.begin().first_order(),
  ...
  // first_order_shrink_to_fit(i)
  {
    ...
    v.first_order_shrink_to_fit();
    v.first_order_shrink_to_fit(v.begin());
  }
