...
void test_vector() {
  ...
  inner::test::test_vector_ownership();
  inner::test::test_vector_briefly<vector<int>>();
  inner::test::test_vector_briefly<vector<int, stateful_test_allocator<int>>>();
  inner::test::test_vector_briefly<vector<test_object<int>>>();
  inner::test::test_vector_carefully<int>();
  inner::test::test_vector_carefully<test_object<int>>();
  inner::test::test_vector_construct_from_range();
  inner::test::test_vector_assign_range();
  inner::test::test_vector_erase();
  inner::test::test_vector_insert_1_back();
  inner::test::test_vector_insert_1();
  inner::test::test_vector_insert_range_back();
  inner::test::test_vector_insert_range();
  inner::test::test_vector_clear();
