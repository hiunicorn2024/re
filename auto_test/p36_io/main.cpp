...
void test_io() {
  ...
  inner::fns::test_c_file();
  inner::fns::test_console_c_file();
  inner::fns::test_fputc_iterator();
  inner::fns::test_sscan();
  inner::fns::test_sprint();
  inner::fns::test_big_int();
  inner::fns::test_sprint_floating_point();
  inner::fns::test_sscan_floating_point();
  inner::fns::test_sscan_sprint_floating_point_by_wide_string();
  inner::fns::test_ssplitter();
  inner::fns::test_ssplit();
  inner::fns::test_file();
  inner::fns::test_file_ralated_fns();
