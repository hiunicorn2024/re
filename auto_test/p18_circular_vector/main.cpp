...
void test_circular_vector() {
  ...
  inner::test::test_circular_vector_iterator();
  inner::test::test_circular_vector_briefly<circular_vector<unsigned>>();
  inner::test::test_circular_vector_briefly
    <circular_vector<unsigned, stateful_test_allocator<unsigned>>>();
  inner::test::test_circular_vector_briefly
    <circular_vector<test_object<unsigned>>>();
  inner::test::test_circular_vector_ownership();
  inner::test::test_circular_vector_construct_from_range();
  inner::test::test_circular_vector_assign_from_range();
  inner::test::test_circular_vector_erase();
  inner::test::test_circular_vector_insert_1_front();
  inner::test::test_circular_vector_insert_1_back();
  inner::test::test_circular_vector_insert_1();
  inner::test::test_circular_vector_insert_range_front();
  inner::test::test_circular_vector_insert_range_back();
  inner::test::test_circular_vector_insert_range();
  inner::test::test_circular_vector_clear();
  inner::test::test_circular_vector_resize();
  inner::test::test_circular_vector_reallocate();
  inner::test::test_circular_vector_shrink_to_fit();
...
int main() {
  ...
  try {
#endif
    inner::test::test_circular_vector();
#ifndef RE_NOEXCEPT
  }
